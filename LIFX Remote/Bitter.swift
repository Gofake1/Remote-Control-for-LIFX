...
extension Int{
    ...
    public var toU8: UInt8{return UInt8(extendingOrTruncating:self)}
    /// Perform a bit pattern truncating conversion to Int8
    public var to8: Int8{return Int8(extendingOrTruncating:self)}
    /// Perform a bit pattern truncating conversion to UInt16
    public var toU16: UInt16{return UInt16(extendingOrTruncating:self)}
    /// Perform a bit pattern truncating conversion to Int16
    public var to16: Int16{return Int16(extendingOrTruncating:self)}
    /// Perform a bit pattern truncating conversion to UInt32
    public var toU32: UInt32{return UInt32(extendingOrTruncating:self)}
    /// Perform a bit pattern truncating conversion to Int32
    public var to32: Int32{return Int32(extendingOrTruncating:self)}
...
extension Int64 {
    ...
    /// Perform a bit pattern truncating conversion to Int
    public var toInt:Int{return Int(extendingOrTruncating:self)}
    /// Perform a bit pattern truncating conversion to UInt
    public var toUInt:UInt{return UInt(extendingOrTruncating:self)}
